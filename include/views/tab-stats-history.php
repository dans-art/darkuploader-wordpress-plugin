        ...
        <div id="stat-uploads-per-target" class="stat-field">
            ...
            <p>
                ...
                foreach ($galleries as $key => $gall) {
                    ...
                    echo sprintf('<p class="stat-item">%s: %s</p>', esc_html($name), esc_html(number_format_i18n($value)));
                }
                ?>
            </p>
        </div>
        <div id="stat-uploads-by-user" class="stat-field">
            ...
            <p>
                ...
                foreach ($user_stats as $user_id => $value) {
                    ...
                    echo sprintf('<p class="stat-item">%s: %s</p>', esc_html($username), esc_html(number_format_i18n($value)));
                }
                ?>
            </p>
        </div>
